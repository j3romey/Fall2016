...
public class CryptoUtilities {
    ...
    ///////////////
    //My methods :D
    public static BigInteger createPrimRoot(BigInteger P, BigInteger Q){
    ...
    public static BigInteger generate_private_key(){
    	Random rnd= new Random();
    	return BigInteger.valueOf(rnd.nextInt(Integer.MAX_VALUE));
    }
    
    public static void sendPublicKey(byte[] message, DataOutputStream out) throws IOException{
    ...
    public static BigInteger recievePublicKey(DataInputStream in) throws IOException{
    	int n = in.readInt();
